...
public class MatchmakerControllerTest {
    ...
    public void testCreateNewUser() {
        PickleballUser user = new PickleballUser(null, "DoeHunter", "John Doe", 25, 3.5, 72758,"admin",null);
    ...
    public void testCreateNewUserFailure() {
        PickleballUser user = new PickleballUser(null, null, "", null, null, 1,"admin",null);
